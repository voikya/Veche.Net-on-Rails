...
module Morphology
  module Alashian
    module Verbs
      module Takteb
        module InitialUnvoicedFricativeAndFinalAspirate
          include Takteb::FinalAspirate

          def subtype
            "C1 = F/Ṯ/S/Š/X, C3 = PH/TH/KH/TSH/ČH"
          end
          ...
          def _present_second_singular_feminine
            if root.tv == "ā"
              [template("τι", :c1, infix, "α", :c2, "α", :c3, "ει"), template("ti", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3, "ī")]
            else
              [template("τα", :c1, infix, "α", :c2, "α", :c3, "ει"), template("ta", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3, "ī")]
            end
          end
          ...
          def _present_third_singular_feminine
            if root.tv == "ā"
              [template("ι", :c1, infix, "α", :c2, "α", :c3, "ει"), template("yi", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3, "ī")]
            else
              [template("ια", :c1, infix, "α", :c2, "α", :c3, "ει"), template("ya", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3, "ī")]
            end
          end

          def _present_first_plural
            if root.tv == "ā"
              [template("νι", :c1, infix, "α", :c2, "α", :c3, "ου"), template("ni", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3, "ū")]
            else
              [template("να", :c1, infix, "α", :c2, "α", :c3, "ου"), template("na", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3, "ū")]
            end
          end

          def _present_second_plural
            if root.tv == "ā"
              [template("τι", :c1, infix, "α", :c2, "α", :c3, "ου"), template("ti", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3, "ū")]
            else
              [template("τα", :c1, infix, "α", :c2, "α", :c3, "ου"), template("ta", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3, "ū")]
            end
          end

          def _present_third_plural
            if root.tv == "ā"
              [template("ι", :c1, infix, "α", :c2, "α", :c3, "ου"), template("yi", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3, "ū")]
            else
              [template("ια", :c1, infix, "α", :c2, "α", :c3, "ου"), template("ya", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3, "ū")]
            end
          end

          def _pf_subjunctive_first_singular
            [template("в̄ω", :c1, infix, "α", :c2, "α", :c3), template("vā", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3)]
          end

          def _pf_subjunctive_first_plural
            [template("в̄ανα", :c1, infix, "α", :c2, "α", :c3), template("vəna", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3)]
          end

          def _pf_subjunctive_second
            [template("в̄ατα", :c1, infix, "α", :c2, "α", :c3), template("vəta", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3)]
          end

          def _pf_subjunctive_third
            [template("в̄ει", :c1, infix, "α", :c2, "α", :c3), template("vī", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3)]
          end
          ...
          def _volitive_first_singular
            [template("α", :c1, infix, "α", :c2, :v, :c3, "αννα"), template("'a", :tc1, infix_transliterated, "a", :tc2, :tv, :tc3, "anna")]
          end

          def _volitive_second_singular_masculine
            if root.tv == "ā"
              [template("τι", :c1, infix, "α", :c2, :v, :c3, "αννα"), template("ti", :tc1, infix_transliterated, "a", :tc2, :tv, :tc3, "anna")]
            else
              [template("τα", :c1, infix, "α", :c2, :v, :c3, "αννα"), template("ta", :tc1, infix_transliterated, "a", :tc2, :tv, :tc3, "anna")]
            end
          end

          def _volitive_third_singular_masculine
            if root.tv == "ā"
              [template("ι", :c1, infix, "α", :c2, :v, :c3, "αννα"), template("yi", :tc1, infix_transliterated, "a", :tc2, :tv, :tc3, "anna")]
            else
              [template("ια", :c1, infix, "α", :c2, :v, :c3, "αννα"), template("ya", :tc1, infix_transliterated, "a", :tc2, :tv, :tc3, "anna")]
            end
          end
          ...
          def _active_participle
            [template("μι", :c1, infix, "α", :c2, "α", :c3), template("mi", :tc1, infix_transliterated, "a", :tc2, "ə", :tc3)]
          end
        end
      end
    end
