...
module Lexicons
  class AlashianMorphology < ActiveRecord::Base
    ...
    STRESSED_VOWEL_REGEX = /(?:(?:(ω|η|ει|ου|ιη|υω)(?=[^αωεηιου]*$))|(?:([αεηιυω]|ει|ου|ιη|υω)(?=(?:[^αωεηιουἠ]+(?:[αειυἠ]|οὐ)){1,2}[^αωεηιου]*$))|(?:(?:(?<=^)|(?<=^[^αωεηιου])|(?<=^[^αωεηιου][^αωεηιου])|(?<=^[^αωεηιου][^αωεηιου][^αωεηιου]))([αειυ])(?=[^αωεηιου]*$)))/
